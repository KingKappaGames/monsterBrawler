function script_createEffectWave(xx, yy, duration, sizeInitial, sizeGrowFlat = 0, sizeGrowMult = 1, color = c_white, thickness = 3, thicknessChange = 0, alphaInner = 1, alphaOuter = 1, depthForce = -yy) {
